...
def HTQuiz():
    ...
    def strike(selected):
        ...
        op1=HTcanvas.create_text(choicePos[0][choices.index(selected)],choicePos[1][choices.index(selected)],text=choices[choices.index(selected)],font=('Helvetica', 15),fill="red")
