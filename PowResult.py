...
def ReturnMark(ans):
    ...
    PTRcanvas.create_rectangle(0, 0, 1000, 8000, fill = "black")
    PTRcanvas.pack(side = "top", fill = "both", expand = True)
    Label(PTRcanvas,text="Your Result",font=("Helvetica",30),bg="black",fg="white").place(x=500,y=50,anchor=CENTER)
