...
def ReturnHTMark(ans):
    ...
    HTRcanvas.create_rectangle(0, 0, 1000, 8000, fill = "black")
    HTRcanvas.pack(side = "top", fill = "both", expand = True)
    Label(HTRcanvas,text="Your Result",font=("Helvetica",30),bg="black",fg="white").place(x=500,y=50,anchor=CENTER)
